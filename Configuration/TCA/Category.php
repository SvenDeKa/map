...
$TCA['tx_z3map_domain_model_category'] = array(
	'ctrl' => $TCA['tx_z3map_domain_model_category']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_z3map_domain_model_category.pid=###CURRENT_PID### AND tx_z3map_domain_model_category.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:z3_map/Resources/Private/Language/locallang_db.xlf:tx_z3map_domain_model_category.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
